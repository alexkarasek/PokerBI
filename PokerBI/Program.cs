...
namespace PokerBI
{
    class Program
    {
               ...
               using (StreamReader sr = new StreamReader(inputfile))
                    ...
                    while ((line_in = sr.ReadLine()) != null)
                    {
                        if (line_in != @"*** SHOW DOWN ***" && line_in != @"*** SUMMARY ***") 
                        {
                            ...
                            {
                                LineParser_wsop(ref line_in, ref street, ref game, ref date, ref site);
                            }
                        }
                    }
        ...
        static void LineParser(ref string line, ref string street, ref string game, ref string date, ref string site)
        {
            try { 
